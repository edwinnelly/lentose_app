...
class controller extends dbc
{
    ...
    public function get_user_data($user_key)
    {
        $query = "select * from member_data where key_grant='$user_key'";
    ...
    /** function to get shop categories 2 **/
    public function getCategories_two($user_key)
    {
        $query = "SELECT * FROM category_two WHERE store_key='$user_key' AND status=1 ";
        $query = $this->run_query($query);
        $categories = array();
        while ($row = $this->get_result($query)) {
            $obj = new stdClass();
    ...
    /** function to get shop categories **/
    public function getCategories_ecom_threes($public_key,$category_id)
    {
        $query = "SELECT * FROM category_three WHERE store_key='$public_key' and category_two='$category_id'";
        $query = $this->run_query($query);
        $categories = array();
        while ($row = $this->get_result($query)) {
            $obj = new stdClass();
...
/** function to get shop categories **/
    ...
    /** function to get shop categories **/
    public function fetch_products($public_key, $batch)
    {
        $query = "SELECT * FROM product_tables WHERE key_grant='$public_key' and ads='$batch'";
        $query = $this->run_query($query);
        $categories = array();
        while ($row = $this->get_result($query)) {
            $obj = new stdClass();
    ...
    //cat1 info
    public function get_cat1($id,$key)
    {
        $query = "select * from category_one where id='$id' and store_key='$key'";
        $row = $this->get_result($this->run_query($query));
        $obj = new stdClass();
        $obj->user_id = $row['id'];
    ...
    public function fetch_prod_dt($public_key, $pid)
    {
        $query = "SELECT * FROM product_tables WHERE key_grant='$public_key' and pid='$pid'";
        $query = $this->run_query($query);
        $categories = array();
        while ($row = $this->get_result($query)) {
            $obj = new stdClass();
