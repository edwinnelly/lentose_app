...
$app = new controller;
 ...
 $ft_vendor = $app->get_vendor_data($get_prod_id,$key_grant);
?><!doctype html>
<html lang="en">
<head>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                        class="fa fa-arrow-left"></i></a>Edit Suppliers</h2>
                        <ul class="breadcrumb">
                            ...
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <input type="submit" class="btn btn-primary font-weight-bold" id="add_vendorse" value="Update Vendor">
                                            </div>
                                        </div>
                                    </div>
                                    </form>
