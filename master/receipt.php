                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-12">
                            <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Customer Receipt</h2>
                            <ul class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>Customer Receipt <small>You can view receipt here</small></h2>
                            </div>
                            <div class="col-lg-12 ">
