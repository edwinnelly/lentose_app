...
<h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Reward Manager</h2>
<ul class="breadcrumb">
...
<div class="card">
<div class="header">
<h2> Reward Manager <small>Add <code>.table-bordered</code> for borders on all sides of the table and cells.</small> </h2>
</div>
