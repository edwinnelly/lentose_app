    ...
    $get_ticket_cat = $app->getCategories_ecom_three($key_grant, $get_sid);
    if($get_sid ==""){
     ...
     echo '<select class="form-control show-tick ms select2" id="category3" data-placeholder="Select" name="cat3">';
