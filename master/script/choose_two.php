    ...
    $get_ticket_cat = $app->getCategories_ecom_two($key_grant, $get_sid);
    ...
    if($get_sid ==""){
        ...
        echo '<select class="form-control show-tick ms select2" id="tic_id" data-placeholder="Select" name="cat2">';
