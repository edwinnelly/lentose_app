        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                        class="fa fa-arrow-left"></i></a>Customer's Order</h2>
                        <ul class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>Customer's Order <small>You can view products here</small></h2>
                            
                                <!-- <button class="btn btn-primary float-right">By Customer</button> -->
                                                <button id="btnGroupDrop1" type="button"
                                                        class="btn btn-primary float-right dropdown-toggle  "
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1"
                                                    ...
                                                    <a class="dropdown-item" href="#">Processing Orders</a>
