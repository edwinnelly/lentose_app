...
<div class="card ">
<!-- <div class="top" >
<img src="logo/lentoseredicon logo.png" alt="Lucid" hieght:100>
</div> -->
<div class="header">
...
<input type="email" class="form-control" id="signin-email" value="" placeholder="Insert OTP code">
</div>
<!-- <div class="form-group">
...
<button type="submit" class="btn btn-primary btn-lg btn-block"style="font-weight:bold;">Verify</button>
<!-- <div class="bottom">
