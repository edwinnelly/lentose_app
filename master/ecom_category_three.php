...
$app = new controller;
$get_sid = base64_decode($app->get_request('sid'));
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><?= $get_last;  ?> / <?= $get_sib;  ?> /  Categories<small>You can add, edit or delete Item Categories here</small></h2>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <tbody>
                                    <?php
                                    $get_category = $app->getCategories_ecom_three($key_grant,$get_sid);
                                    $count = 0;
        ...
        $(document).on('click', '.cc', function () {
            ...
            $("#save_btn").click(function () {
                ...
                $("#submitForm").on('submit',(function(e) {
                    ...
                    $.ajax({
                        url: "script/edit_product_category_ecom_three",
                        type: "POST",
                        data: datas,
                        contentType: false,
                        cache: false,
                        ...
                        success: (data)=> {
                            if(data.trim() == "done"){
                                ...
                                setTimeout(
                                    function () {
                                        window.location.href='ecom_category_three?sid=<?= base64_encode($get_sid); ?>&&sib=<?= base64_encode($get_sib); ?>&&last=<?= base64_encode($get_last); ?>';
                                    }, 2000);
                            }else{
        ...
        $(document).on('click', '.del_cat', function () {
            ...
            $("#del_btn_cat").click(function () {
                ...
                $("#postcatdel").on('submit',(function(e) {
                    ...
                    var datas = new FormData(this);
                    $.ajax({
                        url: "script/del_category_ecom_three",
                        type: "POST",
                        data: datas,
                        contentType: false,
                        cache: false,
