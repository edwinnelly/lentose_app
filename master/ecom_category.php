        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                        class="fa fa-arrow-left"></i></a>Ecommerce Categories</h2>
                        <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2> Ecommerce Categories<small>You can add, edit or delete Item Categories here</small></h2>
            ...
            $(document).on('click', '.cc', function () {
                ...
                $("#save_btn").click(function () {
                    ...
                    $("#submitForm").on('submit',(function(e) {
                        ...
                        $.ajax({
                            url: "script/edit_product_category_ecom",
                            type: "POST",
                            data: datas,
                            contentType: false,
                            cache: false,
                            ...
                            success: (data)=> {
                                if(data.trim() == "done"){
                                    ...
                                    setTimeout(
                                        function () {
                                            window.location.href='ecom_category';
                                        }, 2000);
                                }else{
                                }
                            },
