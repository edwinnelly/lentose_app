        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                        class="fa fa-arrow-left"></i></a>Ads Categories</h2>
                        <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2> Ads Categories<small>You can add, edit or delete ads Categories here</small></h2>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1"
                                                        ...
                                                        <a href="manage_ads?sid=<?= $cc->id; ?>&&ename=<?= $cc->category_postomg; ?>" class="dropdown-item cc" style="cursor: pointer">Manage Ads</a>
            ...
            $(document).on('click', '.cc', function () {
                ...
                $("#save_btn").click(function () {
                    ...
                    $("#submitForm").on('submit',(function(e) {
                        ...
                        $.ajax({
                            url: "script/edit_product_category_ads",
                            type: "POST",
                            data: datas,
                            contentType: false,
                            cache: false,
                            ...
                            success: (data)=> {
                                if(data.trim() == "done"){
                                    ...
                                    setTimeout(
                                        function () {
                                            window.location.href='ads_controls';
                                        }, 2000);
                                }else{
