                ...
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                        class="fa fa-arrow-left"></i></a>New Customer</h2>
                        <ul class="breadcrumb">
                                ...
                                <div class="header">
                                    ...
                                    <div class="col-lg-12 ">
                                        <a href="customer-list">
                                            <button class="btn btn-primary float-right font-weight-bold">View Customer
                                            </button>
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="vcode" id="text" readonly
                                                           value="<?php echo $rand = rand(123456, 1234567); ?>"
                                                           class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="text" name="vname" required
                                                           class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <input type="submit" class="btn btn-primary font-weight-bold"
                                                           id="add_vendorse" value="Add Customer">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
